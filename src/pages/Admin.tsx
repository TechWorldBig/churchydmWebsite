...
export default function Admin() {
  ...
  </div><AdminMemberExport /><AdminReports /><AdminProgramPoints /><AdminWeeklyPrograms /><AdminGallery /></div></section></>
}
