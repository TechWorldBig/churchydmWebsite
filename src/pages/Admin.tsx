...
export default function Admin() {
  ...
  </div><AdminVisitorStats /><AdminMemberExport /><AdminReports /><AdminProgramPoints /><AdminWeeklyPrograms /><AdminGallery /></div></section></>
}
