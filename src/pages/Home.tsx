...
export default function Home() {
  return (
    <>
      ...
      <section className="home-cta bg-[#e3bc62] py-10 sm:py-14"><div className="mx-auto grid max-w-7xl gap-8 px-5 lg:grid-cols-2 lg:items-stretch lg:px-8"><div className="min-h-[300px] overflow-hidden rounded-3xl border border-[#071f19]/15 bg-[#071f19]/10 shadow-[0_14px_32px_rgba(4,21,17,.14)]"><iframe title="Jehovah Salvation Church, Kollamcode location" src="https://www.google.com/maps?q=8.2953514,77.1204252&z=17&output=embed" className="h-full min-h-[300px] w-full border-0" loading="lazy" referrerPolicy="no-referrer-when-downgrade" /></div><div className="flex flex-col justify-center py-2 text-[#071f19]"><p className="text-xs font-bold uppercase tracking-[.2em] text-[#071f19]/85">Visit our church</p><h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">Jehovah Salvation Church</h2><div className="mt-5 flex items-start gap-3 text-sm leading-7 text-[#071f19]/80"><MapPin className="mt-1 shrink-0" size={19}/><p>Kollemcode, Tamil Nadu<br/>Come worship, grow in the Word and connect with our youth community.</p></div><div className="mt-5 rounded-2xl border border-[#071f19]/15 bg-[#071f19]/8 px-4 py-3 text-sm font-semibold leading-6"><span className="block text-xs font-bold uppercase tracking-[.14em] text-[#071f19]/65">Service time</span>12:45 PM–1:30 PM · 1st &amp; 3rd week of every month</div><a href="https://www.google.com/maps/dir/?api=1&destination=8.2953514%2C77.1204252" target="_blank" rel="noreferrer" className="dark-btn mt-7 w-fit">Get directions <ArrowRight size={18}/></a></div></div></section>
    </>
  )
}
