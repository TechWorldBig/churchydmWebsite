...
export default function Home() {
  return (
    <>
      ...
      <section className="home-cta bg-[#e3bc62] py-10 sm:py-14"><div className="mx-auto grid max-w-7xl gap-8 px-5 lg:grid-cols-2 lg:items-stretch lg:px-8"><div className="min-h-[300px] overflow-hidden rounded-3xl border border-[#071f19]/15 bg-[#071f19]/10 shadow-[0_14px_32px_rgba(4,21,17,.14)]"><iframe title="Jehoah Salvation Church, Kollamcode location" src="https://www.google.com/maps?q=8.2953514,77.1204252&z=17&output=embed" className="h-full min-h-[300px] w-full border-0" loading="lazy" referrerPolicy="no-referrer-when-downgrade" /></div><div className="flex flex-col justify-center py-2 text-[#071f19]"><p className="text-xs font-bold uppercase tracking-[.2em] text-[#071f19]/85">Visit our church</p><h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">Jehoah Salvation Church</h2><div className="mt-5 flex items-start gap-3 text-sm leading-7 text-[#071f19]/80"><MapPin className="mt-1 shrink-0" size={19}/><p>Kollemcode, Tamil Nadu<br/>Come worship, grow in the Word and connect with our youth community.</p></div><a href="https://www.google.com/maps/place/JEHOAH+SALVATION+CHURCH+.+KOLLAMCODU/@8.2954263,77.1202552,64a,75y,112.04h,90t/data=!3m7!1e1!3m5!1sBUVTADE687M-Wa3Xp6dUKg!2e0!4m6!3m5!1s0x3b05ab2fae365df3:0xad90a748706c3743!8m2!3d8.2953514!4d77.1204252!16s%2Fg%2F11f6g5dw6j" target="_blank" rel="noreferrer" className="dark-btn mt-7 w-fit">Get directions <ArrowRight size={18}/></a></div></div></section>
    </>
  )
}
